        ...
        <?php
            ...
            try {
                ...
                while($row = $stmt->fetch()) {
                    ...
                    echo "<image src=productImages/$image>";
                    echo "</div>";
                    echo "<p class='productName'>" . $row['product_name'] . "</p>";
                    echo "<p class='productDesc'>" . $row['product_description'] . "</p>";
                    
                    if ($inventory < "10"){
                        echo "<p class='productLowInventory'>" . $inventory . " In Stock!" . "</p>";
                    }
                    else{
                        echo "<p class='productInventory'>" . $inventory . " In Stock!" . "</p>";
                    }
                     
                    if (!empty($status)){
                        echo "<p class='productStatus'>" . $status . "</p>";  
                    }
                    echo "</div>";
                }
