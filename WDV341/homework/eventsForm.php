...
<body>
    ...
    <section>
        ...
        <h2> Set up for an EVENT below </h2>
        <form id="events-form" name="events_form" method="post" action="form-handler.php">
            <p><label for="name">Presentation Name: <input type="text" name="name" id="name"/></label></p>
            <p><label for="description">Description: <textarea id="description" name="description" rows=4 cols=50></textarea></label></p>
            <p><label for="presenter">Presenter: <input type="text" name="presenter" id="presenter"/></label></p>
            <p><label for="date">Date and Time: <input type="datetime-local" name="date" id="date" /></label></p>
